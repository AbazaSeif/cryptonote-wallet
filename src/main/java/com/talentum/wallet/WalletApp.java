package com.talentum.wallet;

import com.talentum.wallet.config.ApplicationProperties;
import com.talentum.wallet.config.DefaultProfileUtil;
...
public class WalletApp {
    ...
    public WalletApp(Environment env) {
        this.env = env;
    }
